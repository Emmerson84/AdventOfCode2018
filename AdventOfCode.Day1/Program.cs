	...
	class Program
	{
		static void Main(string[] args)
		{
			...
			while (dupTracker)
			{
				...
				{
					Console.Write("\r{0}  ", hashset.Count());
					currentFrequency = CalculateFrequency(input[i], currentFrequency);
					dupTracker = hashset.Add(currentFrequency);
					i++;
				}
			}

			//Result = 142991  result: 655
			Console.WriteLine($"result: {currentFrequency}");
			Console.ReadKey();
		}

		public static int CalculateFrequency(int change, int currentFrequncy)
		{
			var newFrequency = currentFrequncy + change;
			return newFrequency;
		}
	}
}