...
namespace AdventOfCode.Day1
{
	class Program
	{
		static void Main(string[] args)
		{
			...
			var duplicates = GetDuplicates(frequencies);
			var i = 0;
			while (duplicates == null)
			{
				Console.Write("\r{0}  ", frequencies.Count());
				if(i == input.Count())
				{
					i = 0;
				}
				...
				{
					frequencies.Add(CalculateFrequency(input[i], frequencies.Last()));
					duplicates = GetDuplicates(frequencies);
					i++;
				}
			}

			Console.WriteLine($"result: {duplicates[0]}"); //142991  result: 655
			Console.ReadKey();
		}

		private static int[] GetDuplicates(List<int> newlist)
		{
		...
		public static int CalculateFrequency(int change, int currentFrequncy)
		{
			currentFrequncy = currentFrequncy + change;
